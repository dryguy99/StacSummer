...
var resultsJuly = ['Win','Loss','','','','','','','','']; //win or loss
var scoreJuly = ['','','','','','','','','','']; // meet score
var linkJuly = ['STAC_July_1_19.pdf','jcc_070119.pdf','','','','','','','','']; // link to external site for results
var NresultsJune = ['TIMES','TIMES','TIMES','','TIMES'] // write RESULTS this turns on the results link on the page
var NresultsJuly = ['TIMES','TIMES','','','','','','','',''];
var NresultsAug = [];
